...
module.exports = {
  ...
  ChangeThermostatFanMessage: ChangeThermostatFanMessage,
...
function ChangeThermostatFanMessage(sessionID, desiredState) {
  /*
  <s:complexType>
    <s:sequence>
...
function toHb(thermostat) {
  ...
  response.CurrentFanState = thermostat.Fan.Position;
  response.TargetFanValues = thermostat.Fan;
  /*
  "Fan": {
    "CanControl": true,
    "Position": "On",
